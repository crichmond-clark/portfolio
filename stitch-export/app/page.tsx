        ...
        <div className="max-w-[1440px] mx-auto w-full flex flex-col md:flex-row items-center justify-between gap-16 relative z-10">
          ...
          >
            ...
            <div className="flex gap-8 items-center">
              <a className="text-on-surface border-b border-outline-variant/40 pb-2 font-mono text-xs flex items-center gap-3 hover:border-on-surface transition-all duration-300 group uppercase tracking-widest" href="#work">
