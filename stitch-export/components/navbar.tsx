...
export function NavBar() {
  ...
  return (
    <motion.nav
      ...
      className="fixed top-0 left-0 right-0 z-40 flex justify-between items-center w-full px-6 md:px-20 py-4 bg-surface-container-low/80 backdrop-blur-md border-b border-outline-variant/10"
    >
